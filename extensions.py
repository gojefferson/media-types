...
EXTENSIONS = {
    'No Mapping': [
        '*-gz', '*.123', '*.3dml', '*.3fr', '*.3g2', '*.3gp', '*.4th', '*.BAS', '*.Bas',
        ...
        '*.mqy', '*.mrc', '*.mrw', '*.ms', '*.mscml', '*.mseed', '*.mseq', '*.msf',
        ...
        '*.sxw', '*.sz', '*.t', '*.tao', '*.tbz', '*.tbz2', '*.tcap', '*.tcl',
        '*.tcsh', '*.teacher', '*.tex', '*.texi', '*.texinfo', '*.text', '*.tfm', '*.tgz',
        '*.thmx', '*.tif', '*.tk', '*.tld', '*.tmo', '*.toast', '*.torrent',
        ...
        '*.w60', '*.wad', '*.war', '*.wax', '*.wb1', '*.wb2', '*.wb3', '*.wbmp',
